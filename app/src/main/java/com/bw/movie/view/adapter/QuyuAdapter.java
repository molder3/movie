 ...
 * function:
 */
public class QuyuAdapter extends RecyclerView.Adapter<QuyuAdapter.QuyuViewHolder> {
    private List<QuyuBean.ResultBean> list;
    private Context context;

    public QuyuAdapter(List<QuyuBean.ResultBean> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull QuyuViewHolder quyuViewHolder, int i) {
        ...
        quyuViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mOnItemClickListener.onItemClick(regionId);
