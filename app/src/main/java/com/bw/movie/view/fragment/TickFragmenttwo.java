...
import com.bw.movie.view.adapter.TicktwoAdapter;
 ...
 * function:
 */
public class TickFragmenttwo extends BeasFragment<TickPrsent> implements ICountView.TickView {
    private RecyclerView cinema_recycler;
    private RelativeLayout lin_visi;
    @Override
    protected int setLyout() {
        return R.layout.ticktwo;
    }
    ...
    protected void intiData() {
        ...
        fpresen.tickd(ussid,ussisnid,2);
    }
    ...
    public void TickSucess(TickBean bean) {
        ...
        if (result != null) {
            ...
            TicktwoAdapter adapter=new TicktwoAdapter(bean.getResult(),getActivity());
